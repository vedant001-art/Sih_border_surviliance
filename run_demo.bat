...
start "BorderSec Backend" cmd /k "cd /d %~dp0 && call venv\Scripts\activate.bat && set FLAGS_use_mkldnn=0&& set FLAGS_enable_pir_api=0&& set OMP_NUM_THREADS=2&& python -m uvicorn backend.main:app --host 0.0.0.0 --port 8000"
